...
levels(housing_test$BldgType)
levels(housing_train$BldgType)
levels(housing_test$Condition1)
levels(housing_train$Condition1)
levels(housing_test$Neighborhood)
levels(housing_train$Neighborhood)
...
categorical_mismatches = data.frame(categories)
